...
public class BarcodeReader extends Fragment
    implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    permissionStatus =
        getActivity().getSharedPreferences("permissionStatus", getActivity().MODE_PRIVATE);
  ...
  public void playBeep() {
    ...
    try {
      ...
      AssetFileDescriptor descriptor =
          getActivity().getAssets().openFd(beepSoundFile != null ? beepSoundFile : "beep.mp3");
