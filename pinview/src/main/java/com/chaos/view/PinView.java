...
public class PinView extends AppCompatEditText {
  ...
  private void drawPinBox(Canvas canvas, int i) {
    ...
    updateRoundRectPath(mItemBorderRect, mPinItemRadius, mPinItemRadius, drawLeftCorner,
        drawRightCorner);
  ...
  private void drawPinLine(Canvas canvas, int i) {
    ...
    mItemLineRect.set(mItemBorderRect.left, mItemBorderRect.bottom - halfLineWidth,
        mItemBorderRect.right, mItemBorderRect.bottom + halfLineWidth);
  ...
  private void updateItemRectF(int i) {
    ...
    float left = getScrollX()
        ...
        + i * (mPinItemSpacing + mPinItemWidth)
        + halfLineWidth;
  ...
  private void drawTextAtBox(Canvas canvas, Paint paint, CharSequence text, int charAt) {
    ...
    float y =
        cy + Math.abs((float) mTextRect.height()) / 2 - mTextRect.bottom;// always center vertical
